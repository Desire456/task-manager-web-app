...
public class XMLQueryValidatorConstants {
    public static final String XML_NOT_FOUND_MESSAGE = "Не найден xml файл";
    ...
    public static final String PATH_TO_XML = "src/main/java/org/netcracker/students/staff/queryResoult.xml";
