...
public class StrategyConstants {
    ...
    public static final String IMPORT_EXCEPTION_MATCH_ID_MESSAGE = "%s with id = %d already exist";
    public static final String IMPORT_EXCEPTION_MATCH_NAME_MESSAGE = "%s with name = %s already exist";
    public static final String IMPORT_EXCEPTION_JOURNAL_NOT_FOUND_MESSAGE = "Can't import task with name " +
